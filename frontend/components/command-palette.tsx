...
export function CommandPalette() {
  ...
  const commands = useMemo<Row[]>(() => {
    ...
    return [
      ...
      nav("Raw Materials", "/items", Icon.Item, "kapda board foam stock"),
      nav("Products", "/products", Icon.Product, "finished goods stock"),
      create("New vendor", "/vendors?new=1", "Add a raw material supplier"),
      create("New karigar", "/karigars?new=1", "Add a thekedaar"),
      create("New material", "/items?new=1", "Add a raw material"),
      create("New product", "/products?new=1", "Add a finished product"),
